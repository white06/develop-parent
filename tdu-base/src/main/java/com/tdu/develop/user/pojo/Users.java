...
public class Users {
    ...
    public String getPresonalPhoto() {
        return presonalPhoto;
    }

    public void setPresonalPhoto(String presonalPhoto) {
        this.presonalPhoto = presonalPhoto;
    }
