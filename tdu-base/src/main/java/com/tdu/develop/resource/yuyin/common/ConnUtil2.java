...
import com.tdu.develop.resource.yuyin.common.DemoException;
...
public class ConnUtil2 {
     ...
     */
    public static String getResponseBytes(HttpURLConnection conn) throws IOException, DemoException {
