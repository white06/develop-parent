...
//		}
        ...
        if(knowlegcontent.getType().equals("PDF")){
            ...
            //服务器路径
			writeFile = new File("/home/working/file.tduvr.org/pdf/"+knowlegcontent.getNmae());
        }else if(knowlegcontent.getType().equals("video")){
            //本机路径
            //	writeFile = new File("D:/wamp/www/newTdu/video/"+knowlegcontent.getNmae());
            //服务器路径
            writeFile = new File("/home/working/file.tduvr.org/video/"+knowlegcontent.getNmae());
        }else if(knowlegcontent.getType().equals(DocumentType)){
            //本机路径
            //writeFile = new File("D:/wamp/www/newTdu//office/"+knowlegcontent.getNmae());
            //服务器路径
            writeFile = new File("/home/working/file.tduvr.org/office/"+knowlegcontent.getNmae());
        }
        if(!writeFile.exists()){
            //创建指定文件
