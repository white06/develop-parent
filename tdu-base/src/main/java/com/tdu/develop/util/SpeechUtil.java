...
public class SpeechUtil {
    ...
    public static final String APP_ID = "19174571";

    public static final String API_KEY = "AWbnYAFxHcUXGllGmAiYHU76";

    public static final String SECRET_KEY = "RFjbFDq8CrpCOOOhVk6CiUdIUyQtFPAK";
...
//        client.setSocketProxy("proxy_host", proxy_port);  // 设置socket代理
     ...
     * @return
     */
    public static String SpeechRecognitionJson(byte[] data, String videoType) {
        // 初始化一个AipSpeech
        client = getInstance();
